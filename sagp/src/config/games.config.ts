...
export const GAMES: GameConfig[] = [
  ...
  },
  {
    ...
    description:
      'Receive live, malicious phone calls from social engineers trying to steal credentials, money, and access. Identify the tactics, verify callers, protect information, and report incidents — before it is too late.',
    type: 'phaser',
