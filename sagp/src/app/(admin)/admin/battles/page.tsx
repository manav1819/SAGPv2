    ...
    <div className="sagp-content-area p-6 lg:p-8 space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="sagp-heading-1 flex items-center gap-3">
          <Swords className="h-7 w-7 sagp-text-primary" />
          Department Battles
        </h1>
      ...
      <div className="flex gap-2 border-b border-slate-700 pb-1">
        {['All', 'Upcoming', 'Active', 'Completed'].map((tab, i) => (
      ...
      <div className="sagp-card flex flex-col items-center justify-center gap-3 py-20 text-center">
        <Swords className="h-12 w-12 sagp-text-muted opacity-30" />
        <p className="sagp-heading-3 sagp-text-muted">No battles scheduled</p>
        <p className="sagp-text-muted text-sm max-w-xs">
          Create inter-department battles to gamify security training across your organisation.
        </p>
      </div>
    </div>
  );
